...
abstract contract NFTDropMarketFixedPriceSale is MarketFees {
   ...
   * @param totalFees The amount of ETH that was sent to Museion & referrals for this sale.
   ...
   * If insufficient msg.value is included, the msg.sender's available METH token balance will be used.
   */
  ...
  function _mintFromFixedPriceSale(
    ...
    // Withdraw from the user's available METH balance if insufficient msg.value was included.
    _tryUseMETHBalance({ totalAmount: mintCost, shouldRefundSurplus: false });
