...
contract MSOMiddleware {
    ...
    )
  {
    ...
    protocol.recipient = market.getMuseionTreasury();
  ...
  /**
   * @notice Retrieves details about the current state of an NFT in the MSO Market.
  ...
  /**
   * @notice Retrieves details about the current state of an NFT in the MSO Market as a string.
