...
contract NFTCollectionFactory is IHasRolesContract, Initializable, Gap10000 {
  ...
  /**
   * @notice Allows Museion to change the NFTCollection implementation used for future collections.
  ...
  /**
   * @notice Allows Museion to change the NFTDropCollection implementation used for future collections.
   * This call will auto-increment the version.
   * Existing collections are not impacted.
